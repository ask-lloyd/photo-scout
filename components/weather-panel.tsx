...
export function WeatherPanel({ weather }: { weather: WeatherData }) {
  ...
  return (
    ...
    >
      ...
      <p className="text-[13px] mb-4" style={{ color: "var(--neutral-300)" }}>
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[13px]" style={{ color: "var(--neutral-300)" }}>Temperature</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[13px]" style={{ color: "var(--neutral-300)" }}>Humidity</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[13px]" style={{ color: "var(--neutral-300)" }}>Wind Speed</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[13px]" style={{ color: "var(--neutral-300)" }}>Visibility</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[13px]" style={{ color: "var(--neutral-300)" }}>Cloud Cover</p>
            </div>
          </div>
          <div>
            <p className="text-[13px] mb-1" style={{ color: "var(--neutral-300)" }}>Cloud Layers</p>
